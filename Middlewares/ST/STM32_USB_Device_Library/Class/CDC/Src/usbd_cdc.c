                               ...
                               uint8_t cfgidx)
{
  ...
  else
  {
    ...
    /* Init  physical Interface components */
		((USBD_CDC_ItfTypeDef *)((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->CDC)->Init();
                                 ...
                                 uint8_t cfgidx)
{
  ...
  if(pdev->pClassData != NULL)
  {
		((USBD_CDC_ItfTypeDef *)((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->CDC)->DeInit();
                                ...
                                USBD_SetupReqTypedef *req)
{
  ...
  case USB_REQ_TYPE_CLASS :
    if (req->wLength)
    {
      ...
      {
				((USBD_CDC_ItfTypeDef *)((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->CDC)->Control(
																													req->bRequest,
                                                          (uint8_t *)hcdc->data,
                                                          req->wLength);
...
{      
  ...
  if(pdev->pClassData != NULL)
  {
		((USBD_CDC_ItfTypeDef *)((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->CDC)->Receive(hcdc->RxBuffer, &hcdc->RxLength);
...
{ 
  USBD_CDC_HandleTypeDef   *hcdc = (USBD_CDC_HandleTypeDef*) pdev->pClassData;
  if((((USBD_CDC_ItfTypeDef *)((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->CDC) != NULL) && (hcdc->CmdOpCode!=0xFF))
                                      ...
                                      USBD_CDC_ItfTypeDef *fops)
{
  ...
  if(fops != NULL)
  {
		((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->CDC=fops;
    //pdev->pUserData= fops;
    ret = USBD_OK;    
  }
